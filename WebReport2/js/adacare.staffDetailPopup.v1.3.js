...
//
// adacare.staffDetailPopup.v1.3.js
// Sandy Gettings
//
...
// 2018-01-13 SG: Changes for preloaded text in "send message" pop-up.
...
adacare.staffDetailPopup.info = {
    ...
    openMessagingPopupButtonSurroundID: 'StaffDetailOpenMessagingPopupButtonSurround',
...
adacare.staffDetailPopup.init = function (officeID, begDateStr, begTimeStr, frequencyStr, openButtonID, buddyElemID) {
    'use strict';
    ...
    adacare.staffDetailPopup.info.begDateTime = adacare.lib.parseDateTimeLocalized(adacare.lib.countryAbbr, begDateStr, begTimeStr);
    adacare.staffDetailPopup.info.frequencyStr = frequencyStr;
...
adacare.staffDetailPopup.onClickOpenButton = function () {
    ...
    var officeID, staffID, fullname, buddyElemID, begDate, begDateTime, frequencyStr;
    ...
    begDateTime = adacare.staffDetailPopup.info.begDateTime;
    frequencyStr = adacare.staffDetailPopup.info.frequencyStr;
    ...
    adacare.staffDetailPopup.fetchStaffDetailWS(officeID, staffID, begDate, begDateTime, frequencyStr);
};
...
adacare.staffDetailPopup.fetchClientDetailWS = function (officeID, clientID, begDate, begTime, frequencyStr) {
    'use strict';
    ...
    AdaCareWeb.WebServices.CalServices.FetchClient(
        officeID, clientID, begDate,
        '', // No preloaded message text. Implement if needed
        adacare.staffDetailPopup.WSSuccess,
        adacare.staffDetailPopup.WSFailed,
        'adacare.staffDetailPopup.fetchClientDetailWS');
};

adacare.staffDetailPopup.fetchStaffDetailWS = function (officeID, staffID, begDate, begDateTime, frequencyStr) {
    'use strict';

    var preloadedMessageText;

    preloadedMessageText = adacare.staffDetailPopup.preloadedMessageTextForStaff(begDateTime, frequencyStr);

    AdaCareWeb.WebServices.CalServices.FetchStaff(
        officeID, staffID, begDate,
        preloadedMessageText,
        adacare.staffDetailPopup.WSSuccess,
        adacare.staffDetailPopup.WSFailed,
...
adacare.staffDetailPopup.WSSuccess = function (returnedValue, context, methodName) {
    ...
    switch (methodName) {
        ...
        case 'FetchClient':
            ...
            adacare.staffDetailPopup.setMessagingPopupButtonHandler(adacare.staffDetailPopup.info.openMessagingPopupButtonSurroundID, calClient.OpenMessagingPopupJavaScriptCode);
            break;
        ...
        case 'FetchStaff':
            ...
            adacare.staffDetailPopup.setMessagingPopupButtonHandler(adacare.staffDetailPopup.info.openMessagingPopupButtonSurroundID, calStaff.OpenMessagingPopupJavaScriptCode);
            break;
...
adacare.staffDetailPopup.setMessagingPopupButtonHandler = function (surroundID, openMessagingPopupJavaScriptCode) {
    'use strict';
...
adacare.staffDetailPopup.preloadedMessageTextForStaff = function (begDateTime, frequncyString) {
    'use strict';

    var preloadedMessageText;

    preloadedMessageText = frequncyString
        + ' beginning '
        + adacare.lib.formatDateLocalized(adacare.lib.countryAbbr, begDateTime)
        + ' '
        + adacare.lib.FormatTimeLocalized(adacare.lib.countryAbbr, begDateTime)
        + ':';
