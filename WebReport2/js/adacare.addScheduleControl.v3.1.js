...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//
// adacare.AddScheduleControl.v3.1             Sandy Gettings
//
...
// 2018-10-24 SG: Added abaility to issue postback when selected staff changes.
...
adacare.AddScheduleControl = {
    ...
    info: {
        ...
        // Server-side control that's used to "click" when the selcted staff is changed

        selectedStaffChangedButtID: null,
    ...
    initStaffSelectMenu: function (
        ...
        selectedStaffChangedButtID) {
        'use strict';

        var selectedStaffID;

        this.info.$selectedStaffID = $('#' + selectedStaffIDElemID);
        this.info.selectedStaffChangedButtID = selectedStaffChangedButtID;
    ...
    onSelectedStaffChange: function (thisValue, thisText) {
        ...
        $('#' + adacare.AddScheduleControl.info.selectedStaffChangedButtID).click();
    },
