...
//
// adacare.messagingTools.v1.7.js         Sandy Gettings
//
...
adacare.messagingTools = {
    ...
    initForViewerDesktop: function (appUserID, deliveryMethodDropDownListIDs, enableMessagesToClients, enableMessagesToOfficeUsers, enableMessagesToStaff) {
        ...
        this.initMessageTextBox(this.onViewerMessageSendButtClick, null);
    ...
    initForPopupForSingleRecipient: function (recipientName,
        ...
        this.initMessageTextBox(this.onPopupMessageSendButtClick, preloadedMessageText);
    ...
    initMessageTextBox: function (sendButtClickHandler, preloadedMessageText) {
        'use strict';
        ...
        // 2018-01-01 SG: Preload any given text. For example, "About your visit on 01/01/2018:".

        if (preloadedMessageText) {

            this.$messageTextBox.val(preloadedMessageText); // Hope the caller didn't exceed the max characters for the message!
            this.$messageTextBox.keyup();                   // Updates the character count displays.
        }
    },
