...
// 2014-12-21 SG: Revised neuro.cal.staffList to index by integer rather than staff's ID. Keeps list alphabetical.
// 2015-01-04 SG: Improvements to edit dialog's selectmenu for staff.
// 2015-04-23 SG: Added icon tag for supervisor notes.
// 2015-12-29 SG: Added travel hourly rates.
// 2016-04-30 SG: Added button for displaying ChangeLog.
// 2016-07-17 SG: Removed "last updated" field, made obsolete by ChangeLog.
// 2017-04-29 SG: Added support for messaging popup button.
// 2017-07-11 SG: Minor fix to call surround width for Safari.
// 2017-07-12 SG: Update for compatibility with jQuery 2.2.4.
// 2017-07-19 SG: Minor fix for bug in resorting edited visits, by removing hide() with special effects.
// 2017-07-25 SG: Performance improvements using CSS instead of the same style in each visit element.
// 2017-07-27 SG: Performance improvements for displaying large numbers of visits.
// 2017-07-31 SG: Define constants for calendar views, used to support client/staff detail pop-up.
// 2018-01-14 SG: Added support for preferred staff in the staff SelectMenu drop-down list.
// 2018-04-20 SG: Added support for emergency phone numbers.
// 2018-08-08 SG: Updated "VisitTemplate" to "VisitTemplate".
// 2018-08-25 SG: Added support for ClientPayers.
...
neuro.cal.$editDialog = null;
neuro.cal.$editDialogVisitID = null;
...
neuro.cal.editDialogClientEmergencyPhoneID = '';
neuro.cal.editDialogClientEmailID = '';
neuro.cal.editDialogClientEmailUrlID = '';
neuro.cal.editDialogClientOpenMessagingPopupButtonSurroundID = 'EditDialogClientOpenMessagingPopupButtonSurround';
...
neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_PREFERRED_INDEX = 1;
neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_PREFERRED_TITLE = 'Preferred Staff';
neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_ALL_INDEX = 2;
...
neuro.cal.editDialogStaffEmergencyPhoneID = '';
neuro.cal.editDialogStaffEmailID = '';
neuro.cal.editDialogStaffEmailUrlID = '';
neuro.cal.editDialogStaffOpenMessagingPopupButtonSurroundID = 'EditDialogStaffOpenMessagingPopupButtonSurround';
neuro.cal.editDialogStaffContactInfoID = '';
neuro.cal.editDialogClientPayerID = '';
neuro.cal.editDialogContractID = '';
neuro.cal.editDialogVisitTemplateID = '';
...
neuro.cal.editDialogScheduledDepartureTimeID = 'EditDialogScheduledDepartureTime';

// Recorded times.

neuro.cal.editDialogRecordedArrivalTimeID = 'EditDialogRecordedArrivalTime';
neuro.cal.editDialogRecordedDepartureTimeID = 'EditDialogRecordedDepartureTime';

neuro.cal.editDialogBillingMinutesID = 'EditDialogBillingMinutes';
neuro.cal.editDialogBillingTravelDistanceID = 'EditDialogBillingTravelDistance';
neuro.cal.editDialogBillingTravelMinutesID = 'EditDialogBillingTravelMinutes';

neuro.cal.editDialogPayrollMinutesID = 'EditDialogPayrollMinutes';
neuro.cal.editDialogPayrollTravelDistanceID = 'EditDialogPayrollTravelDistance';
neuro.cal.editDialogPayrollTravelMinutesID = 'EditDialogPayrollTravelMinutes';

neuro.cal.editDialogUpdateButtonID = 'EditDialogUpdateButt'; // Buttons for the edit dialog, must match the button's HTML
neuro.cal.editDialogCancelButtonID = 'EditDialogCancelButt';
neuro.cal.editDialogDeleteButtonID = 'EditDialogDeleteButt';

// ChangeLog purge days. This should really be passed in from the caller. Otherwise, updating the server-side
// C# constant means we have to remember to update its counterpart here as well.

neuro.cal.editDialog_VISIT_CHANGE_LOG_PURGE_AFTER_DAYS_WARNING = 180;
...
neuro.cal.visitClassVisitTagSurround = 'cal_visit_tag_surround';
...
// These MUST match the values in the CalRepos.ViewMode enum.

neuro.cal.VIEW_MODE_UNDEFINED = 0;
neuro.cal.VIEW_MODE_DAILY_ALL_RESOURCE_VIEW = 1;
neuro.cal.VIEW_MODE_WEEKLY_ALL_RESOURCE_VIEW = 2;
neuro.cal.VIEW_MODE_WEEKLY_SINGLE_RESOURCE_VIEW = 3;
...
// Predefined jQuery object for common DOM elements.

neuro.cal.$body = null; // 2017-07-26 SG
...
neuro.cal.initStacked = function (
    ...
    neuro.cal.$body = $('#' + bodyID); // 2017-07-26 SG:  Use this instead of always seaching for the body element. Delete the prperty above.
    ...
    // Not appropriate for stacked calendar, since its rows represent staff, not hours.
...
neuro.cal.initCommon = function () {
    ...
    neuro.cal.visitTemplateList = [];               // List of visit templates
...
neuro.cal.adjustCalendarWidth = function () {
    ...
    newWidth = Math.min($('.' + neuro.cal.SURROUNDING_CLASS).width() - 10, 1060); // 2017-07-11 SG. Boy is this a hack. See max-width of masterpage_outer
...
neuro.cal.resizeCalendar = function () {
    ...
    var BOT_MARGIN = 70;    // Best guess for anything below the footer
    ...
    // 2017-07-04 SG: New calculation since master page CSS was changed

    var documentHeight, windowHeight, $panel, panelTop;
    var headerHeight, footerHeight, panelNewHeight;

    documentHeight = $(document).height();
    windowHeight = $(window).outerHeight();
    $panel = $('#' + neuro.cal.outerbodyID);
    panelTop = $panel.offset().top;
    //var panelHeight = $panel.outerHeight();
    //var panelBot = panelTop + panelHeight;
    headerHeight = panelTop;
    footerHeight = $('#CalFooter').outerHeight() + BOT_MARGIN;
    panelNewHeight = windowHeight - headerHeight - footerHeight;
    panelNewHeight = Math.max(panelNewHeight, MIN_HEIGHT);
    $panel.height(panelNewHeight);
};
...
neuro.cal.initEditDialog = function (
    ...
    editDialogClientEmergencyPhoneID,
    ...
    editDialogStaffEmergencyPhoneID,
    ...
    editDialogClientPayerID,
    editDialogContractID,
    editDialogVisitTemplateID,
    ...
    neuro.cal.$editDialog = $('#' + editDialogID);                                  // Edit visit dialog div
    ...
    neuro.cal.$editDialogVisitID = $('#' + editDialogVisitIDID);                    // Visit ID field
    ...
    neuro.cal.editDialogClientEmergencyPhoneID = editDialogClientEmergencyPhoneID;  // Client emergency phone field
    ...
    neuro.cal.editDialogStaffEmergencyPhoneID = editDialogStaffEmergencyPhoneID;          // Staff emergency phone field
    ...
    neuro.cal.editDialogClientPayerID = editDialogClientPayerID;                    // ClientPayer
    neuro.cal.editDialogContractID = editDialogContractID;                          // Contract
    neuro.cal.editDialogVisitTemplateID = editDialogVisitTemplateID;                // VisitTemplate
    ...
    // Bind a function to the VisitTemplate control, so that the VisitTemplate's minutes
    // are recalculated whenever the control is changed.

    $('#' + editDialogVisitTemplateID).bind('change', function (e) {

        var ID;
        ID = $('#' + editDialogVisitTemplateID).val();
        $('#' + editDialogBaseMinutesID).text(neuro.cal.getVisitTemplateMinutesFormatted(ID));
    });
    ...
    $('#' + neuro.cal.editDialogExtraMinutesID).bind('change', function (e) {
        ...
        var visitTemplateID, a, b;
        visitTemplateID = $('#' + neuro.cal.editDialogVisitTemplateID).val();
        a = parseInt($('#' + neuro.cal.editDialogExtraMinutesID).val(), 10);
        b = neuro.cal.getVisitTemplateMinutes(visitTemplateID);
...
neuro.cal.editDialogStaffSelectMenuInit = function () {
    ...
    var staff; //, staffID;
    var groupForRecentStaff, groupForPreferredStaff, groupForAllStaff;
    ...
    groupForPreferredStaff = new adacare.SelectMenu.Group(neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_PREFERRED_TITLE, []);
    ...
    groupList[neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_PREFERRED_INDEX] = groupForPreferredStaff;
    groupList[neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_ALL_INDEX] = groupForAllStaff;

    //adacare.SelectMenu.destroy(neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_ELEM_ID);
...
neuro.cal.editDialogStaffSelectMenuUpdateRecent = function (recentStaffIDList, preferredStaffIDList) {
    'use strict';

    var recentStaffGroupItem, recentStaffGroupItemList = [];
    var preferredStaffGroupItem, preferredStaffGroupItemList = [];
    var staff;
    var i;

    // Construct the "recent staff" group.
    ...
    for (i = 0; i < recentStaffIDList.length; i++) {
        ...
        if (staff !== null) {
            ...
            recentStaffGroupItem = new adacare.SelectMenu.GroupItem(staff.fullname, staff.ID, false);
            recentStaffGroupItemList[recentStaffGroupItemList.length] = recentStaffGroupItem;
        }
    }

    // Construct the "preferred staff" group.

    for (i = 0; i < preferredStaffIDList.length; i++) {

        staff = this.getStaff(preferredStaffIDList[i]);

        if (staff !== null) {

            preferredStaffGroupItem = new adacare.SelectMenu.GroupItem(staff.fullname, staff.ID, false);
            preferredStaffGroupItemList[preferredStaffGroupItemList.length] = preferredStaffGroupItem;
        }
    }

    adacare.SelectMenu.updateGroup(neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_ELEM_ID, neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_RECENT_INDEX, recentStaffGroupItemList);
    adacare.SelectMenu.updateGroup(neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_ELEM_ID, neuro.cal.EDIT_DIALOG_STAFF_SELECTMENU_GROUP_PREFERRED_INDEX, preferredStaffGroupItemList);
...
neuro.cal.Client = function (ID, displayRow, fullname) {
    ...
    this.ID = Number(ID); // 2018-08-28 SG: Enforced type as "Number"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// VisitTemplate constructor.

neuro.cal.VisitTemplate = function (ID, shortName, descrip, minutesLength, billingUseEstimate, billingMinutesEstimate, payrollUseEstimate, payrollMinutesEstimate) {
    'use strict';
...
neuro.cal.Visit = function (visitID, scheduleID, outcomeID, visitDate, groupNum, clientID, staffID, begDateTime, visitTemplateID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
    ...
    this.hasVisitNotes = hasVisitNotes;
    this.hasSupervisorNotes = hasSupervisorNotes;
...
neuro.cal.Visit.prototype.baseMinutes = function () { return neuro.cal.getVisitTemplateMinutes(this.visitTemplateID); };
...
neuro.cal.addClient = function (ID, displayRow, fullname) {
    ...
    var client, clientCount;

    client = new neuro.cal.Client(ID, displayRow, fullname);
    //neuro.cal.clientList[ID] = client;
    clientCount = neuro.cal.clientList.length;
    neuro.cal.clientList[clientCount] = client;
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// Add a visit template to the calendar.

neuro.cal.addVisitTemplateFromServer = function (AddVisitTemplateItemJson) {
    'use strict';

    var vt;

    vt = new neuro.cal.VisitTemplate(AddVisitTemplateItemJson.ID,
        AddVisitTemplateItemJson.ShortName,
        AddVisitTemplateItemJson.Descrip,
        AddVisitTemplateItemJson.MinutesLength,
        AddVisitTemplateItemJson.BillingUseEstimate,
        AddVisitTemplateItemJson.BillingMinutesEstimate,
        AddVisitTemplateItemJson.PayrollUseEstimate,
        AddVisitTemplateItemJson.PayrollMinutesEstimate);

    neuro.cal.visitTemplateList[AddVisitTemplateItemJson.ID] = vt;
};
...
neuro.cal.addVisitFromServer = function (AddVisitItemJson) {
    ...
    neuro.cal.addVisit(
        ...
        AddVisitItemJson.VisitTemplateID,
        ...
        AddVisitItemJson.HasVisitNotes,
        AddVisitItemJson.HasSupervisorNotes);
};

// Use this version for local JavaScript calls.

neuro.cal.addVisit = function (visitID, scheduleID, outcomeID, visitDateStr, groupNum, clientID, staffID, begDateTimeStr, visitTemplateID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
...
/* 2017-07-27 SG: Replaced to add visits in bulk - much faster
...
neuro.cal.displayAllVisits = function () {
    ...
    for (index in neuro.cal.visitList) {
        ...
        vList[i] = v;
        $newElemList[i] = $newElem;
        i++;
    }

    // Append the list of new visit elements to the page body in one operation (faster!),
    // then place the elems on their proper place on the page.

    //neuro.cal.$body.append($newElemList);

    for (i = 0; i < vList.length; i++) {
        neuro.cal.placeVisit(vList[i], $newElemList[i], true);
    }
...
neuro.cal.enableWidgets = function (jqSelector) {
    ...
    bodyElem = neuro.cal.$body[0]; // 2017-07-26 SG
    $allVisits = $(jqSelector).dblclick(neuro.cal.onDoubleClickVisit);

    // This is a bit slow when we have a lot of visits.
...
neuro.cal.constructSingleVisitElem = function (v, visitID, parentVisitID) {
    'use strict';
    ...
    // 2017-07-27 SG: "repeater" element no longer needed since it was moved to tags.
    ...
    elemHtml = elemHtmlTemplate.replace('{0}', vElemID).replace('{3}', neuro.cal.visitClassBase)
        ...
        .replace('{13}', neuro.cal.visitClassVisitTagSurround);
    //.replace('{13}', vElemRepeaterID).replace('{14}', neuro.cal.visitClassRepeater);

    //tagSurroundHtml = tagSurroundTemplate.replace('{0}', neuro.cal.visitClassVisitTagSurround).replace('{1}', tagHtml);

    //$newElem = $(elemHtml).appendTo('#' + neuro.cal.bodyID);
    //$newElem = $(elemHtml).appendTo(neuro.cal.$body); // 2017-07-26 SG, chnaged 2017-07-27
    $newElem = $(elemHtml);
...
neuro.cal.addSpecialClasses = function (v, $vElem) {
    ...
    //var $vElemRepeater;
    var $tempElem, visitTagMstrID, $visitTagSurround, visitTagCode, visitTagCss, i;
    var classesToRemove, classesToAdd;

    // These are add-on elements, to append icon tags to the visit.

    //var tagSurroundHtml, tagSurroundTemplate = '<div class="{0}">{1}</div>'; // Surrounds the tags
    ...
    classesToRemove = neuro.cal.visitClassDefault
        + ' ' + neuro.cal.visitClassKept
        + ' ' + neuro.cal.visitClassAvailable
        + ' ' + neuro.cal.visitClassWarning
        + ' ' + neuro.cal.visitClassUnassigned;

    $vElem.removeClass(classesToRemove);

    // Remove any add-on elements (used for various icons attached to the visit)

    if (isKept) {
        classesToAdd = neuro.cal.visitClassKept;
    }
    else if (v.isAvailable) {
        classesToAdd = neuro.cal.visitClassAvailable;
    }
    else if (isUnassigned) {
        classesToAdd = neuro.cal.visitClassUnassigned;
    }
    else if (needWarning) {
        classesToAdd = neuro.cal.visitClassWarning;
    }
    else {
        classesToAdd = neuro.cal.visitClassDefault;
    }

    $vElem.addClass(classesToAdd);
    ...
    // Add the "has notes" tags.

    if (v.hasVisitNotes) { tagHtml += tagTemplate.replace('{0}', neuro.VisitTags.CSS_HAS_VISIT_NOTES); }
    if (v.hasSupervisorNotes) { tagHtml += tagTemplate.replace('{0}', neuro.VisitTags.CSS_HAS_SUPERVISOR_NOTES); }
    ...
    // Just FYI: The following lines of code are kinda slow, which only matters because this is in a loop.

    $visitTagSurround = $vElem.find('.' + neuro.cal.visitClassVisitTagSurround);
    $visitTagSurround.html(tagHtml);
...
neuro.cal.placeVisit = function (v, $vElem, isInitialLoad) {
    'use strict';

    switch (neuro.cal.calType) {
        case neuro.cal.CALTYPE_OVERLAY:
            neuro.cal.placeOverlayVisit(v, $vElem, isInitialLoad);
            break;

        case neuro.cal.CALTYPE_STACKED:
            neuro.cal.placeStackedVisit(v, $vElem, isInitialLoad);
            break;
...
neuro.cal.placeOverlayVisit = function (v, $vElem, isInitialLoad) {
    'use strict';

    var coords, elemHeight;
    //var elemWidth; // 2017-07-25 SG Moved width to CSS
    ...
    neuro.cal.$body.append($vElem); // 2017-07-28 SG
    ...
    if (slotRowColBot.col === slotRowColTop.col) {
        ...
        //elemWidth = neuro.cal.visitWidth; // 2017-07-25 SG Moved width to CSS

        //$vElem.css({ 'height': elemHeight, 'width': elemWidth }); // 2017-07-25 SG Moved width to CSS
        $vElem.css({ 'height': elemHeight });
        ...
        // 2017-07-27 SG: Already added times when visit element was constructed
        ...
        if ((slotRowColTop.col + 1) < neuro.cal.colsPerGroup) {
            ...
            if ($vElemOflow.length === 0) {
                //neuro.cal.constructVisitElem(v, visitOflowID, v.visitID); // 2017-07-27 SG
                $vElemOflow = neuro.cal.constructSingleVisitElem(v, visitOflowID, v.visitID);
                neuro.cal.$body.append($vElemOflow);
            }
            ...
            //$vElemOflow.css({ 'height': elemHeight, 'width': elemWidth }); // 2017-07-25 SG Moved width to CSS
            $vElemOflow.css({ 'height': elemHeight });
...
neuro.cal.placeStackedVisit = function (v, $vElem, isInitialLoad) {
    'use strict';
    ...
    //$vElem.css('left', 0).css('top', 0); // 2017-07-25 SG Moved to CSS
    ...
    //$vElem.find('*').andSelf().each(function () { neuro.cal.makeUnselectable(this); }); // Not compatible with jQuery 2.2.4

    $vElem.find('*').addBack().each(function () { neuro.cal.makeUnselectable(this); });
...
neuro.cal.deleteVisit = function (visitID) {
    ...
    // With the upgrade to jQuery v2.2.4 (or a bit earlier), we had to remove call to the hide() method
    // because it runs asynchronously. In particular, the code below to sort the visits in the calendar
    // slot is executed *before* the element is deleted. This causes the soon-to-be-deleted element to
    // be included in the sorting, which blows up rather nastily.
    //
    // Another way to slve this might be to change the way the sorting function works, but for now, just
    // removing the animation is fine.

    $('#' + v.vElemID).remove();

    if ($('#' + v.vElemOflowID).length > 0) {
        $('#' + v.vElemOflowID).remove();
    }

    // Removal of elements *must* be completed before sorting.
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// Get a client or staff from the list.
//
...
neuro.cal.getClient = function (ID) {
    'use strict';

    var client = null;
    var i;

    for (i = 0; i < neuro.cal.clientList.length; i++) {

        if (neuro.cal.clientList[i].ID === ID) {

            client = neuro.cal.clientList[i];
            break;
        }
    }
...
neuro.cal.mapSlotToClientID = function (slot) {
    ...
    switch (neuro.cal.calType) {
        ...
        case neuro.cal.CALTYPE_STACKED:
            ...
            if (i === neuro.cal.clientList.length) {
...
neuro.cal.mapVisitToRowByParms = function (clientID, staffID) {
    ...
    if (neuro.cal.rowsRepresentClients) {
        ...
        // 2018-08-28 SG: Improved

        for (i = 0; i < neuro.cal.clientList.length; i++) {

            if (neuro.cal.clientList[i].ID === clientID) {

                rowNum = neuro.cal.clientList[i].displayRow;
                break;
            }
        }
    }
...
neuro.cal.mapCoordToSlot = function (top, left) {
    ...
    switch (neuro.cal.calType) {
        ...
        case neuro.cal.CALTYPE_STACKED:
            ...
            parentOffset = neuro.cal.$body.offset(); // 2017-07-26 SG
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// Get the number of minutes for the given VisitTemplate ID.

neuro.cal.getVisitTemplateMinutes = function (ID) {
    'use strict';

    var visitTemplate;

    visitTemplate = neuro.cal.visitTemplateList[ID];

    return (visitTemplate ? visitTemplate.minutesLength : 0); // Guard against bad VisitTemplate
};

///////////////////////////////////////////////////////////////////////////////////////////////////
// Get the number of minutes for the given VisitTemplate ID, in a text format.

neuro.cal.getVisitTemplateMinutesFormatted = function (ID) {
    'use strict';

    var m, mFormatted;

    m = neuro.cal.getVisitTemplateMinutes(ID);
