...
neuro.cal.editvisit.OpenDetails = function (title, updatePanelID, clientstaffID, fullname, clientstaffHiddenID, newView, elemID) {
    ...
    //var junkeoffset = $elem.offset();
    //var junkewidth = $elem.outerWidth(); // DEBUG
    //var junkpwidth = $elem.parent().outerWidth(); // DEBUG
    //var junkparent = $elem.parent(); // DEBUG
    //var junkparent2 = $elem.parent().parent(); // DEBUG
    ...
    $dialogSurroundDiv.appendTo($elem.parent());
    $dialogSurroundDiv.css({
