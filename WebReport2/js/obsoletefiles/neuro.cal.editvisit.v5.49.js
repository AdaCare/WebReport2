...
neuro.cal.editvisit.OpenDetails = function (title, updatePanelID, clientstaffID, fullname, clientstaffHiddenID, newView, elemID) {
    ...
    //$viewCalendarButt.unbind(); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
...
neuro.cal.editvisit.EraseVisitJoinForEdit = function () {
    ...
    //$('#' + neuro.cal.editDialogVisitTemplateID).unbind().change(neuro.cal.editvisit.ChangeVisitTemplateSelect); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    ...
    //$('#' + neuro.cal.editDialogDatePickerHiddenID).unbind().change(neuro.cal.editvisit.ChangeDatePicker); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    ...
    //$('#' + neuro.cal.editDialogTimePickerID).unbind().change(neuro.cal.editvisit.ChangeTimePicker); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    ...
    //$('#' + neuro.cal.editDialogActualArrivalTimeID).unbind().change(neuro.cal.editvisit.ChangeArrivalDepartureSelect); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    //$('#' + neuro.cal.editDialogActualDepartureTimeID).unbind().change(neuro.cal.editvisit.ChangeArrivalDepartureSelect); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    ...
    for (i = 0; i < CalUpdateInfoList.length; i++) {
        ...
        switch (CalUpdateInfo.Action) {
            ...
            case neuro.cal.editvisit.ACTION_ADD:
                ...
                //neuro.cal.constructVisitElem(v, visitID, visitID); // 2017-07-27 SG
...
neuro.cal.editvisit.updateAfterDrag = function (v, vElem, updateAllFuture) {
    ...
    var newVisitDate, newVisitDateTime, newStaffID, /*newClientPayerID, newContractID,*/ newVisitTemplateID, newExtraMinutes;
    var vElemPos, vElemOffset, slot0Offset;
    ...
    neuro.cal.editvisit.updateVisitJoinWS(v, updateAllFuture, true,
        newVisitDateTime, newStaffID, /*newClientPayerID*/ 0, /*newContractID*/ 0, newVisitTemplateID, newExtraMinutes,
...
neuro.cal.editvisit.updateAfterResize = function (v, vElem, updateAllFuture) {
    ...
    var newVisitDateTime, newStaffID, /*newClientPayerID, newContractID,*/ newVisitTemplateID, newExtraMinutes;
