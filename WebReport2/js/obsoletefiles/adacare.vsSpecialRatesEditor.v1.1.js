...
//
// adacare.vsSpecialRatesEditor.v1.1.js         Sandy Gettings        
//
// Revised 06/15/2011
//
...
adacare.vsSpecialRatesEditor.GetValues = function (surroundID) {
    ...
    VSEValues.billingFlatRate = adacare.lib.stringToNumber($('#' + VSEParm.billingFlatRateID).val());
    VSEValues.billingHourlyRate = adacare.lib.stringToNumber($('#' + VSEParm.billingHourlyRateID).val());
    VSEValues.billingTravelRate = adacare.lib.stringToNumber($('#' + VSEParm.billingTravelRateID).val());
    VSEValues.payrollUseThisRate = $('#' + VSEParm.payrollUseThisRateID).prop('checked');
    VSEValues.payrollFlatRate = adacare.lib.stringToNumber($('#' + VSEParm.payrollFlatRateID).val());
    VSEValues.payrollHourlyRate = adacare.lib.stringToNumber($('#' + VSEParm.payrollHourlyRateID).val());
    VSEValues.payrollTravelRate = adacare.lib.stringToNumber($('#' + VSEParm.payrollTravelRateID).val());
...
adacare.vsSpecialRatesEditor.SetValues = function (surroundID, VSEValues) {
    ...
    //$('#' + VSEParm.useSpecialRatesID).attr('checked', VSEValues.billingUseThisRate); editing trash???
    ...
    $('#' + VSEParm.billingTravelRateID).val(adacare.lib.formatCurrency(VSEValues.billingTravelRate));
    ...
    $('#' + VSEParm.payrollTravelRateID).val(adacare.lib.formatCurrency(VSEValues.payrollTravelRate));
