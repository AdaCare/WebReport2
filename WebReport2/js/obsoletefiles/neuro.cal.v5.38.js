...
//neuro.cal.editDialogWhoWhenUpdatedID = 'EditDialogWhoWhenUpdated'; // 2016-07-17 SG
...
neuro.cal.Visit = function (visitID, outcomeID, scheduleID, visitDate, groupNum, clientID, staffID, begDateTime, visitTemplateID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
...
neuro.cal.addVisit = function (visitID, outcomeID, scheduleID, visitDateStr, groupNum, clientID, staffID, begDateTimeStr, visitTemplateID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
...
neuro.cal.addSpecialClasses = function (v, $vElem) {
    ...
    // 2017-07-28 SG: Just remove all classes at once.
    ...
    // 2017-07-28 SG: Updated for simpler code.
    ...
    // 2017-07-28 SG: Move the tag's div to the constructSingleVisitElem() function, and just replace the HTML inside the div.

    //tagSurroundHtml = tagSurroundTemplate.replace('{0}', neuro.cal.visitClassVisitTagSurround).replace('{1}', tagHtml);
    //$vElem.find('.' + neuro.cal.visitClassVisitTagSurround).remove();
