...
neuro.map = {
    ...
    ***/
    ...
    AddressItem: function (street, city, state, postalCode, country, title, content, lat, lng, quality) {
        ...
        if (quality !== undefined && quality !== neuro.map.GEOCODE_QUALITY_MISSING) {
    ...
    addAddressItem: function (street, city, state, postalCode, country, poiTitle, poiContent, lat, lng, quality) {
        'use strict';

        var thisAddressItem, index;

        thisAddressItem = new neuro.map.AddressItem(street, city, state, postalCode, country, poiTitle, poiContent, lat, lng, quality);
    ...
    geocodeAddressList: function (myCallback) {
        ...
        if (locationList.length > 0) {
            ...
            MQA.withModule('geocoder', function () {
                ...
                //MQA.Geocoder.geocode(locationList, null, null, function (response, errinfo, myCallback) { neuro.map.geocodeAddressListCallback(response, errinfo, myCallback); });
    ...
    /***
    geocodeAndDrawAddressListOBSOLETE: function () {
        'use strict';
    ...
    ***/
    ...
    geocodeAddressListCallback: function (response) {
        ...
        var latLng, displayLatLng, quality;
        var mapUrl;
        var addressItem, addressCount, a;
