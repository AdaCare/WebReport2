...
//
// adacare.clockInOutActivityLogDetailPopup.v3.0.js
// Sandy Gettings
//
...
adacare.clockInOutActivityLogDetailPopup = {
    ...
    displayDetails: function (displayInfo, displayText, clockInOutActivityLogForWS) {
        ...
        var TEMPLATE_TOP_PREFIX = '<p>The step-by-step details are shown below:</p>';
        var TEMPLATE_TOP = '<table>';
        var TEMPLATE_HEAD = '<tr class="{0}"><th class="{1}">&nbsp;</th><th class="{2}">When</th><th class="{3}">State</th><th class="{4}">Action</th><th class="{5}">Keys Pressed</th><th class="{6}">&nbsp;</th></tr>';
        var TEMPLATE_ROW = '<tr><td class="{0}">{1}.</td><td class="{2}">{3}</td><td class="{4}">{5}</td><td class="{6}">{7}</td><td class="{8}">{9}</td><td class="{10}">{11}</td></tr>';
        var TEMPLATE_BOT = '</table>';
        ...
        if (clockInOutActivityLogForWS && clockInOutActivityLogForWS.ClockInOutActivityLogDetailForWSList) {
            ...
            if (clockInOutActivityLogDetailForWSList.length > 0) {
                ...
                displayHtml = TEMPLATE_TOP_PREFIX;
                displayHtml += TEMPLATE_TOP;
                displayHtml += TEMPLATE_HEAD
                    .replace('{0}', this.CSS_CLASS_DETAILS_HEADER_ROW)
                    .replace('{1}', this.CSS_CLASS_DETAILS_INDEX)
                    .replace('{2}', this.CSS_CLASS_DETAILS_DATETIME)
