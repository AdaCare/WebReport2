...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//
// adacare.SelectMenu.v1.2             Sandy Gettings                                      12/04/2014
//
...
adacare.SelectMenu = {
    ...
    init: function (
        ...
        infoItem.$control.selectmenu({
            ...
            //appendTo: 'form', // Some users report an unresponsive drop-down list. Does this help?
    ...
    ***/
    ...
    fitToWindow: function (infoItem) {
        ...
        var widgetTop, widgetHeight, widgetWidth, windowHeight;
        var zIndexOfParent;
        ...
        //  Resize the selectmenu's button to allow for the triangle icon.

        widgetWidth = $widget.outerWidth();
        $widget.outerWidth(widgetWidth + 32);
        //var widgetWidthAFTER = $widget.outerWidth();
        ...
        $menuWidget.parent().css('z-index', zIndexOfParent + 1); // BUG: Increments self z-index on each call
        $menuWidget.scrollTop(0);
    },
