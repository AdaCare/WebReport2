...
//
// adacare.vsEditor.v1.7.js         Sandy Gettings              Revised 09/31/2011
//
...
// Subfrequency codes for "daily." 

adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_DAY = 'E';
adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_N_DAYS = 'N';
adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_WEEKDAY = 'D';
adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_WEEKENDDAY = 'S';
adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_DOWLIST = 'L';

// Subfrequency codes for "weekly."
...
adacare.vsEditor.init = function (
    ...
    adacare.vsEditor.setImpliedDaysOfWeek(VSEParm, subfrequency);
...
// just gets/sets that single character within the list. For example, the "Daily" frequency is the
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// Set the DOW to match certain cases of the daily subfrequency.

adacare.vsEditor.setImpliedDaysOfWeek = function (VSEParm, subfrequency) {
    'use strict';
    ...
    switch (subfrequency) {
        ...
        case adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_DAY:
            $('#' + VSEParm.daysOfWeekServerID).val(adacare.vsEditor.DOW_BUTTON_MASK_EVERY_DAY);
            break;

        case adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_WEEKDAY:
            $('#' + VSEParm.daysOfWeekServerID).val(adacare.vsEditor.DOW_BUTTON_MASK_EVERY_WEEKDAY);
            break;

        case adacare.vsEditor.SUBFREQUENCY_DAILY_EVERY_WEEKENDDAY:
...
adacare.vsEditor.clickedFrequency = function () {
    ...
    // If the user clicked the Daily frequency, we'll set the DOW to the implied values.

    frequency = $('[name="' + VSEParm.frequencyServerName + '"]:checked').val();

    if (frequency === adacare.vsEditor.FREQUENCY_DAILY) {
