...
//
// adacare.sigPadEditor.v1.0.js       Sandy Gettings
//
...
adacare.sigPadEditor = {
    ...
    initSigPad: function (surroundID) {
        ...
        infoItem.signaturePad = new SignaturePad(
            infoItem.$canvas[0],
            {
                backgroundColor: /*'rgba(0,0,0,0)'*/ 'White', // Use opaque white background for best JPG. If you prefer, PNG supports transparency.
                penColor: 'Blue',
                onEnd: function () {
