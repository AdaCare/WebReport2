...
adacare.SelectMenu = {
    ...
    fitToWindow: function (infoItem) {
        ...
        //var junk1w = $widget.css('z-index');
        //var junk2wp = $widget.parent().css('z-index');
        //var junk2wpp = $widget.parent().parent().css('z-index');
        //var junkelemwp = $widget.parent();
        //var junk1m = $menuWidget.css('z-index');
        var junk2mp = $menuWidget.parent().css('z-index');
        //var junk2mpp = $menuWidget.parent().parent().css('z-index');
        //var junkelemmp = $menuWidget.parent();
        ////$menuWidget.css('z-index', $widget.parent().css('z-index') + 1);
