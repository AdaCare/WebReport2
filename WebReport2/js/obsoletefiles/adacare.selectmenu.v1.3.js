...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//
// adacare.SelectMenu.v1.3             Sandy Gettings                                      12/04/2014
//
...
adacare.SelectMenu = {
    ...
    init: function (
        ...
        this.displaySelection(infoItem, selectedValue);
        //this.fitToWindowHeight(infoItem);
    ...
    fitToWindowHeight: function (infoItem) {
        ...
        newMenuHeight = windowHeight + windowScrollTop - widgetTop - widgetHeight - MENU_BOTTOM_MARGIN_PX;
