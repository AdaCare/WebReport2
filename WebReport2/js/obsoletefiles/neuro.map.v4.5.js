...
neuro.map = {
    ...
    initGpsMap: function (clientLat, clientLng, clientGeoquality, deviceLat, deviceLng, deviceAccuracy, gpsMaxDistanceToClientMeters, clientTitle, clientContent) {
        'use strict';
        ...
        iconGpsAccuracyDiameter = (deviceAccuracy / mapResolution) * 2;
    ...
    updateGpsMap: function (deviceLat, deviceLng, deviceAccuracy, gpsMaxDistanceToClientMeters) {
        'use strict';
        ...
        // Reposition and resize the "bullseye" and "accuracy" icons
    ...
    AddressItem: function (street, city, state, postalCode, country, title, content, lat, lng, geoquality, geocodeMissingAndStale) {
        ...
        this.geocodeMissingAndStale = (geocodeMissingAndStale ? geocodeMissingAndStale : false); // Sez geocode is missing *and* it's due to recheck
    ...
    geocodeAddressList: function (myCallback) {
        ...
        for (i = 0; i < addressCount; i++) {
            ...
            // /* DEBUG ONLY! */ addressItem.geoquality = neuro.map.GEOCODE_QUALITY_MISSING; // DEBUG ONLY! FORCE GEOCODING
            ...
            if (addressItem.geocodeMissingAndStale) {
                ...
                // DEBUG
                AdaCareWeb.WebServices.DebugServices.WriteLogDebug('neuro.map.geocodeAddressList: #' + locationList.length
        ...
        if (locationList.length > 0) {
            ...
            if (locationList.length === 1) {
                locationList[locationList.length] = locationList[0];
            }

            MQA.withModule('geocoder', function () {

                //adacare.evvClockInOutLogDetailPopup.wsSuccess, adacare.evvClockInOutLogDetailPopup.wsFail, 'adacare.evvClockInOutLogDetailPopup.fetchEVVClockInOutLog');
    ...
    geocodeAddressListCallback: function (response) {
        'use strict';
