...
neuro.cal.Visit = function (visitID, outcomeID, scheduleID, visitDate, groupNum, clientID, staffID, begDateTime, visitTypeID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
...
neuro.cal.addVisit = function (visitID, outcomeID, scheduleID, visitDateStr, groupNum, clientID, staffID, begDateTimeStr, visitTypeID, extraMinutes, visitFinalStatus, visitTagIDList, hasProblems, freqOnce, isAvailable, hasVisitNotes, hasSupervisorNotes) {
    'use strict';
