// Copyright 2009 - 2014 by Neurosoftware, LLC.
//
// neuro.cal.editvisit.v5.26.js
// Sandy Gettings
//
...
//
// Revised 2013-10-11
// Revised 2013-12-19 Fix bug in changing visit final status. It was using the old status in comparison.
// Revised 2014-04-07 SG Changes to support new datepicker (V3.1).
// Revised 2014-09-27 SG Added code for visit tags.
// Revised 2014-11-12 SG
...
neuro.cal.editvisit.Edit = function (e, vElem) {
    ...
    // Clear the "recent staff" group. We'll fill it in when we egt the client's info later.
        ...
        switch (CalUpdateInfo.Action) {
            ...
            case neuro.cal.editvisit.ACTION_ADD:
                ...
                neuro.cal.addVisit(
                    ...
                    CalUpdateInfo.CalVisitJoin.hasNotes);
            ...
            case neuro.cal.editvisit.ACTION_UPDATE:
                ...
                for (visitID in neuro.cal.visitList) {
                    ...
                    if (((v.scheduleID > 0 && v.scheduleID == scheduleIDBefore) || (v.outcomeID > 0 && v.outcomeID == outcomeIDBefore)) &&
                        ...
                        v.hasNotes = CalUpdateInfo.CalVisitJoin.hasNotes;
