...
//
// adacare.lib.v2.27                Sandy Gettings              Revised 12/11/2013
//
...
// 2017-04-25 SG: Added modalDialogForClient() function.
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// For modal dialogs opened client-side by JavaScript.

adacare.lib.modalDialogForClient = function (action, dialogID, titleText, widthPx, cancelButtonID) {
    ...
    switch (action) {
        ...
        case 'close':
            ...
            // Any other option is a programming error.                                                                                                                                                 
        default:
            throw new Error('adacare.lib.modalDialogForClient: bad action from caller (' + action + ')');
            //break;
    }
