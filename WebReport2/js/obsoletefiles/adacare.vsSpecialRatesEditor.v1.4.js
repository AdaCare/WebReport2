...
//
// adacare.vsSpecialRatesEditor.v1.4.js         Sandy Gettings        
//
// Revised 06/18/2013
//
...
adacare.vsSpecialRatesEditor.init = function (
    ...
    billingUseThisRateID, billingFlatRateID, billingHourlyRateID, billingTravelDistanceRateID,
    payrollUseThisRateID, payrollFlatRateID, payrollHourlyRateID, payrollTravelDistanceRateID
    ) {
...
adacare.vsSpecialRatesEditor.displayFields = function (VSEParm) {
    ...
    var $billingUseThisRate, $billingFlatRate, $billingHourlyRate, $billingTravelDistanceRate;
    var $payrollUseThisRate, $payrollFlatRate, $payrollHourlyRate, $payrollTravelDistanceRate;
