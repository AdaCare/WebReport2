...
neuro.cal.editvisit.EraseVisitJoinForEdit = function () {
    ...
    //$('#' + neuro.cal.editDialogContractID).unbind(); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
...
neuro.cal.editvisit.updateAfterEdit = function (visitID, updateAllFuture) {
    ...
    var v;
    var dateStr, timeStr;
    var newVisitDateTime, newStaffID, newContractID, newVisitTemplateID, newVisitTagIDList;
    ...
    neuro.cal.editvisit.updateVisitJoinWS(v, updateAllFuture, false,
        newVisitDateTime, newStaffID, newContractID, newVisitTemplateID, newExtraMinutes,
...
neuro.cal.editvisit.updateAfterDrag = function (v, vElem, updateAllFuture) {
    ...
    var newVisitDate, newVisitDateTime, newStaffID, newVisitTemplateID, newExtraMinutes; //, newNotes;
    var vElemPos, vElemOffset, slot0Offset;
    ...
    neuro.cal.editvisit.updateVisitJoinWS(v, updateAllFuture, true,
        newVisitDateTime, newStaffID, 0, newVisitTemplateID, newExtraMinutes,
...
neuro.cal.editvisit.updateAfterResize = function (v, vElem, updateAllFuture) {
    ...
    var newVisitDateTime, newStaffID, newVisitTemplateID, newExtraMinutes; //, newNotes;
