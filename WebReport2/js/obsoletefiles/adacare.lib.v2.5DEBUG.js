...
//
// adacare.lib.v2.5                Sandy Gettings              Revised 8/10/11
//
...
resultDate = $.datepicker.parseDate(dateFormatLocalized, dateStr);
...
/***
adacare.lib.FormatTimeMinutes = function (minutes) {

    return adacare.lib.FormatTimeMinutesLocalized(adacare.lib.countryAbbr, minutes);
