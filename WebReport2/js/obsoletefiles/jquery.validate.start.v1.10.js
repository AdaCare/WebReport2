...
//
// jquery.validate.start.v1.10.js      Sandy Gettings              Revised 6/18/2013
//
...
//  jquery.maskedinput-1.3.1.min.js       (the masked input plugin, needed for date fields)
...
adacare.validateInit = function (alwaysInit, isPostBack) {
    ...
    if (!adacare.validate.initialized || alwaysInit) {
        ...
        //jQuery('.val_phone_gi').livequery(function (e) { $(this).mask('99999999'); }); // No - does not support Spanin as well
