...
//
// neuro.aheditor.v1.3                Sandy Gettings              Revised 04/10/2012
//
...
/***
neuro.aheditor.setScroll = function () {

var scrollIndex;
var $dayGridKids, $scrollToElement, parentPosition, scrollToPosition;
var $dayGrid;
var DayParm;

DayParm = neuro.aheditor.getDayParm(0); // Grab any day
$dayGrid = $('#' + DayParm.dayGridID);

scrollIndex = Math.floor(neuro.aheditor.scrollToMinute / neuro.aheditor.minPerSlot);
...
//var junksdheight = $('#' + neuro.aheditor.scrollingDivID).outerHeight();
//var junkdgheight = $dayGrid.outerHeight();
//$('#' + neuro.aheditor.scrollingDivID).scrollTop(junkoh * scrollIndex);
//$('.aheditor_scrollingdiv').scrollTop(junkoh * scrollIndex);
neuro.aheditor.scrollCurrent = junkoh * scrollIndex;
...
/***
neuro.aheditor.syncScroll = function () {

$('.aheditor_scrollingdiv').scrollTop(neuro.aheditor.scrollCurrent);
};
***/
...
/***
neuro.aheditor.handleScroll = function (e) {
...
neuro.aheditor.scrollCurrent = divScroll;
};
***/
