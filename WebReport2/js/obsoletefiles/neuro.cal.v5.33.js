...
neuro.cal.visitVisitTagSurround = 'cal_visit_tag_surround';
...
neuro.cal.addSpecialClasses = function (v, $vElem) {
    ...
    tagSurroundHtml = tagSurroundTemplate.replace('{0}', neuro.cal.visitVisitTagSurround).replace('{1}', tagHtml);
    $vElem.find('.' + neuro.cal.visitVisitTagSurround).remove();
