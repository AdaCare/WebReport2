...
//
// adacare.vsEditor.v1.3.js         Sandy Gettings              Revised 09/31/2011
//
...
adacare.vsEditor.subfrequencyDailyNameBase = 'SubfrequencyDaily';       // All Daily Subfrequency radio buttons start with the same name
adacare.vsEditor.subfrequencyWeeklyNameBase = 'SubfrequencyWeekly';     // All Weekly Subfrequency radio buttons start with the same name
...
adacare.vsEditor.init = function (
    ...
    if (VSEParm === undefined) {
        ...
        VSEParm.subfrequencyDailyName = VSEParm.surroundDivServerID + '_' + adacare.vsEditor.subfrequencyDailyNameBase;
        VSEParm.subfrequencyWeeklyName = VSEParm.surroundDivServerID + '_' + adacare.vsEditor.subfrequencyWeeklyNameBase;
    ...
    $radioButtList = $('#' + VSEParm.frequencyDailyDivID + ' [name="' + adacare.vsEditor.subfrequencyDailyNameBase + '"]');
    $radioButtList.attr('name', VSEParm.subfrequencyDailyName);

    $radioButtList = $('#' + VSEParm.frequencyWeeklyDivID + ' [name="' + adacare.vsEditor.subfrequencyWeeklyNameBase + '"]');
    $radioButtList.attr('name', VSEParm.subfrequencyWeeklyName);
    ...
    $('#' + VSEParm.surroundDivServerID + ' [name="' + VSEParm.subfrequencyDailyName + '"]').click(adacare.vsEditor.clickedSubfrequency);
    $('#' + VSEParm.surroundDivServerID + ' [name="' + VSEParm.subfrequencyWeeklyName + '"]').click(adacare.vsEditor.clickedSubfrequency);
...
adacare.vsEditor.displayFields = function (VSEParm) {
    ...
    switch (frequency) {
        ...
        case adacare.vsEditor.FREQUENCY_DAILY:
            ...
            // ORIG $('#' + VSEParm.surroundDivServerID + ' [name="' + VSEParm.subfrequencyDailyName + '"][value="' + subfrequency + '"]').prop('checked', true);
            //$subfreqelem = $('#' + VSEParm.frequencyDailyDivID + ' [name="' + VSEParm.subfrequencyDailyName + '"]').filter('[value="' + subfrequency + '"]');

            //var $junk = $('[name="ctl00_ctl00_ContentMain_ContentMain_VSEditor1_FrequencySurround_SubfrequencyDaily"]').filter('[value="E"]'); // DEBUG
            //var junkchek = $junk.prop('checked'); // DEBUG
            $subfreqelem = $('[name="' + VSEParm.subfrequencyDailyName + '"]').filter('[value="' + subfrequency + '"]');
            $subfreqelem.prop('checked', true);
            //junkchek = $junk.prop('checked'); // DEBUG
        ...
        case adacare.vsEditor.FREQUENCY_WEEKLY:
            ...
            // ORIG $('#' + VSEParm.surroundDivServerID + ' [name="' + adacare.vsEditor.subfrequencyWeeklyName + '"][value="' + subfrequency + '"]').prop('checked', true);
            //$subfreqelem = $('#' + VSEParm.frequencyWeeklyDivID + ' [name="' + VSEParm.subfrequencyWeeklyName + '"]').filter('[value="' + subfrequency + '"]');
            $subfreqelem = $('[name="' + VSEParm.subfrequencyWeeklyName + '"]').filter('[value="' + subfrequency + '"]');
            $subfreqelem.prop('checked', true);
        ...
        case adacare.vsEditor.FREQUENCY_MONTHLY:
            ...
            // ORIG $('#' + VSEParm.surroundDivServerID + ' [name="' + adacare.vsEditor.subfrequencyMonthlyName + '"][value="' + subfrequency + '"]').prop('checked', true);
        ...
        case adacare.vsEditor.FREQUENCY_YEARLY:
            ...
            // ORIG $('#' + VSEParm.surroundDivServerID + ' [name="' + adacare.vsEditor.subfrequencyYearlyName + '"][value="' + subfrequency + '"]').prop('checked', true);
