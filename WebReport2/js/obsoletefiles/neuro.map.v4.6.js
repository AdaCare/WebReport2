    ...
    geocodeAddressList: function (myCallback) {
        ...
        if (locationList.length > 0) {
            ...
            MQA.withModule('geocoder', function () {
                ...
                //adacare.clockInOutActivityLogDetailPopup.wsSuccess, adacare.clockInOutActivityLogDetailPopup.wsFail, 'adacare.clockInOutActivityLogDetailPopup.fetchClockInOutActivityLog');
