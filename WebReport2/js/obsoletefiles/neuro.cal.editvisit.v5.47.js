...
neuro.cal.editvisit.EraseVisitJoinForEdit = function () {
    ...
    //$('#' + neuro.cal.editDialogVisitTypeID).unbind().change(neuro.cal.editvisit.ChangeVisitTypeSelect); // 2018-01-08 SG:Unbind() is deprecated in jQuery 3
    $('#' + neuro.cal.editDialogVisitTypeID).off('change').change(neuro.cal.editvisit.ChangeVisitTypeSelect); 
