...
//
// adacare.changeLogPopup.v1.1.js         Sandy Gettings             Revised 09/31/2011
//
...
adacare.changeLogPopup = {
    ...
    wsSuccess: function (returnedValue, context, methodName) {
        ...
        //var TABLE_HEAD = '<table class="gridview_content"><tr class="gridview_header"><th class="general_left">Date</th><th class="general_left">Activity</th><th class="general_left">Login ID</th><th class="general_left">&nbsp;</th></tr>';
        //var TABLE_ROW_TEMPLATE = '<tr class="{0}"><td class="general_left">{1}</td><td class="general_left">{2}</td><td class="general_left">{3}</td><td class="general_left">{4}</td></tr>';
        var TABLE_HEAD = '<table><tr class="changeLogPopupHeader"><th class="changeLogPopupIndex">&nbsp;</th><th class="changeLogPopupDateTime">Date</th><th class="changeLogPopupActivity">Activity</th><th class="changeLogPopupLoginID">Login ID</th><th class="changeLogPopupDescrip">Schedule</th></tr>';
        var TABLE_ROW_TEMPLATE = '<tr class="{0}"><td class="changeLogPopupIndex">{1}.</td><td class="changeLogPopupDateTime">{2}</td><td class="changeLogPopupActivity">{3}</td><td class="changeLogPopupLoginID">{4}</td><td class="changeLogPopupDescrip">{5}</td></tr>';
            ...
            if (changeLogReportList.length > 0) {
                ...
                for (i = 0; i < changeLogReportList.length; i++) {
                    ...
                    htmlRow += TABLE_ROW_TEMPLATE
                        ...
                        .replace('{1}', i + 1)
                        .replace('{2}', changeLogReportList[i].ChangeDateTimeLocalToString)
                        .replace('{3}', changeLogReportList[i].ChangeTypeDescrip)
