...
adacare.vsEditor.init = function (
    ...
    $('#' + VSEParm.surroundDivServerID + ' [name="' + adacare.vsEditor.subfrequencyDailyDOWName + '"]').click(adacare.vsEditor.clickedDailyDOW);
    $('#' + VSEParm.surroundDivServerID + ' [name="' + adacare.vsEditor.subfrequencyWeeklyDOWName + '"]').click(adacare.vsEditor.clickedWeeklyDOW);
