...
neuro.cal.editvisit.WSSuccess = function (returnedValue, context, methodName) {
    ...
    var $newElem;
    var telephonyID = '';
    var address = '', cityState = '', resPhone = '', mobilePhone = '', emailAddress = '', emailAddressUrl = '', contactInfoHtml = '', schedulingPrefsHtml = '', billingMinutesToString = '', payrollMinutesToString = '';
    var groupNum;
...
neuro.cal.editvisit.displayClientForEditWS = function (calClient) {
    ...
    var address = '', cityState = '', resPhone = '', mobilePhone = '', emailAddress = '', emailAddressUrl = '', contactInfoHtml = '', schedulingPrefsHtml = '', billingMinutesToString = '';
