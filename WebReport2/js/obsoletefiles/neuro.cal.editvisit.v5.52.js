...
neuro.cal.editvisit.EraseVisitJoinForEdit = function () {
    ...
    $('#' + neuro.cal.editDialogActualArrivalTimeID).off('change').change(neuro.cal.editvisit.ChangeArrivalDepartureSelect);
    $('#' + neuro.cal.editDialogActualDepartureTimeID).off('change').change(neuro.cal.editvisit.ChangeArrivalDepartureSelect);
...
neuro.cal.updateBillingAndPayrollHoursFromEdit = function () {
    ...
    billingMinutes = (visitTemplate.billingUseEstimate ? visitTemplate.billingMinutesEstimate : actualMinutes);
    payrollMinutes = (visitTemplate.payrollUseEstimate ? visitTemplate.payrollMinutesEstimate : actualMinutes);
...
neuro.cal.editvisit.displayVisitJoinForEditWS = function (calVisitJoin) {
    ...
    if (calVisitJoin !== null) {
        ...
        actualArrivalDateTimeLocal = (calVisitJoin.ActualArrivalDateTime ? new Date(calVisitJoin.ActualArrivalDateTimeStr) : null);
