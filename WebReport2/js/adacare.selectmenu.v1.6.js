...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//
// adacare.SelectMenu.v1.6             Sandy Gettings                                      12/04/2014
//
...
// 2017-07-25 SG Workaround for jQuery UI bug #15078 in selectmenu, where repeated calls get slower and slower.
//               This causes the Calendar to get *much* slower when opening the pop-up dialog to edit many visits.
...
adacare.SelectMenu = {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    // Re-init the SelectMenu. This function inits the jQuery UI widget proper.

    initJQWidget: function (infoItem) {
        'use strict';
        ...
        // Recreate the selectmenu from scratch, as a  workaround for jQuery UI bug #15078 in selectmenu.
        // Delete this after bug is fixed.

        if (infoItem.$control.selectmenu('instance')) {
            infoItem.$control.selectmenu('destroy');
        }
    ...
    refresh: function (controlID) {
        ...
        // Temp workaround to jQuery UI bug #, should be fixed in v1.12.2.
        // Original code (use this after bug is fixed)
        //infoItem.$control.selectmenu('refresh');

        // Workaround code (delete after bug is fixed)
        this.initJQWidget(infoItem);
        //infoItem.$control.selectmenu('refresh');
